                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                            <tr>
                                                <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                    <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 1px; font-weight: 400; line-height: 0; text-align: center; color: #424549;">Please confirm your password request!</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                            ...
                                            <tr>
                                                <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;width: 160px;" width="160"> <a href="{{ URL('/') }}" target="_blank" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; padding: 0 10px;"> <img alt="SILDMS" height="auto" src="{{ asset('img/logo_white.png') }}" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="160"> </a> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="right" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; text-align: right; font-size: 0px; word-break: break-word;">
                                                    <div class="inline-links" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;">
                                                        ...
                                                        <![endif]--> <a class="link" href="#" target="_blank" style="display: inline-block; color: #808080; font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 13px; font-weight: bold; line-height: 22px; text-decoration: none; text-transform: none; padding: 0 10px;"> My Account </a> <!--[if mso | IE]>
                                                        </td>
                                                        </tr>
                                                        </table>
                                                        <![endif]-->
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                                        <tr>
                                                            <td align="left" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 26px; font-weight: bold; line-height: 30px; text-align: left; color: #e5e5e5;">Please confirm your password request!</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; color: #e5e5e6; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #e5e5e6;"><br>
                                                                    Please confirm,that you personally required a new password.
                                                                    For this reason we sent this email with OTP.
...
{{--                                                                    is sent to you in a further email at the disposal. --}}
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; color: #e5e5e6; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 300; line-height: 25px; text-align: left; color: #e5e5e6;">OTP :
                                                                    <strong>
{{--                                                                        <a style='font-weight: bold;color: #2E9CC3;' href="{$LINK}">{$LINK}</a>--}}
                                                                        {{ $otp }}
                                                                    </strong> <br>
                                                                </div>
                                                            </td>
...
{{--                                                                    <tr>--}}
{{--                                                                        <td align="center" bgcolor="#dd2c00" role="presentation" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; border: none; border-radius: 3px; cursor: auto; mso-padding-alt: 10px 25px; background: #dd2c00;" valign="middle"> <a href="{$LINK}" style="display: inline-block; background: #dd2c00; color: #eee; font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 18px; font-weight: bold; line-height: 120%; margin: 0; text-decoration: none; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 3px;" target="_blank"> Get Your New Password</a> </td>--}}
{{--                                                                    </tr>--}}
{{--                                                                </table>--}}
{{--                                                            </td>--}}
{{--                                                        </tr>--}}
                                                        <tr>
                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; color: #e5e5e6; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                <div style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align: left; color: #e5e5e6;"><br> If you have any questions, please, <a target='_blank' style='font-weight: bold;color: #2E9CC3;' href="#">Contact Us</a>! <br></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                    <div style="font-family:OpenSans, Helvetica, Tahoma, Arial, sans-serif;font-size:12px;font-weight:400;line-height:20px;text-align:center;color:#bdbdbd;">
                                                        <div>
                                                            <a href="#" target="_blank" style="color: #e5e5e8; line-height: 20px; text-decoration: underline;">Home</a> |
                                                            <a href="#" style="color: #e5e5e8; line-height: 20px; text-decoration: underline;">My Orders</a> |
                                                            <a href="#" target="_blank" style="color: #e5e5e8; line-height: 20px; text-decoration: underline;">Specials</a> |
                                                            <a href="#" style="color: #e5e5e8; line-height: 20px; text-decoration: underline;">Brands</a> |
                                                            <a href="#" target="_blank" style="color: #e5e5e8; line-height: 20px; text-decoration: underline;">New Products</a>
                                                        </div>
                                                        <br /> &copy; {{ date('Y') }} SILDMS
                                                        <br />
                                                    </div>
                                                </td>
                                            </tr>
