...
'use strict';
    ...
    $(document).ready(function()
    {
        ...
        var dTable = $('#stream_table').DataTable({
            ...
            /*
             * create an element id to change Stream names, while inline datatable updated
            */
            createdRow: function ( row, data, index ) {
                var td_index = data.DT_RowIndex;
                $('td', row).eq(0).attr('id', 'perm_'+data.id);
                $('td', row).eq(0).attr('title', 'Click to edit Stream');
             },
        ...
        // only those have manage_Stream Stream will get access
        // @can is a blade syntax
        dTable.MakeCellsEditable({
            "onUpdate": updateStream, //call function to update in backend
    ...
    function updateStream (updatedCell, updatedRow, oldValue)
    {
